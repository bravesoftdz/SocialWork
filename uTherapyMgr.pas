...
uses
  ...
  dxSkinsCore, dxSkinCaramel, Menus, cxStyles,
  ...
  dxSkinOffice2007Blue, cxPCdxBarPopupMenu, cxPC, ExtCtrls,
  ...
  dxSkinWhiteprint, dxSkinscxPCPainter, dxBarBuiltInMenu, cxNavigator,
  cxSchedulerRecurrence, cxSchedulerRibbonStyleEventEditor,
  cxSchedulerTreeListBrowser, dxSkinscxSchedulerPainter;
