...
uses
  ...
  cxGroupBox, cxCheckBox, DB, ADODB, uGlobal;
...
begin
  ...
  if dbMain.RemakeCounselingOrder(nInOutID, sMeetingDate) then
...
procedure TfrmCounseling.btnShortKeyClick(Sender: TObject);
begin
