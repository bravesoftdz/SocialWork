object frmShortKeyMgr: TfrmShortKeyMgr
  Left = 0
  Top = 0
  ...
  object cxG: TcxGrid
    ...
    TabOrder = 0
    ExplicitHeight = 483
    object cxGShortKey: TcxGridDBTableView
      OnDblClick = cxGShortKeyDblClick
      OnKeyDown = cxGShortKeyKeyDown
      DataController.DataSource = dsShortKey
      ...
      object cxGShortKeyKeyword: TcxGridDBColumn
        DataBinding.FieldName = 'Keyword'
      end
    end
    object cxGLevel1: TcxGridLevel
      GridView = cxGShortKey
    end
  end
  object btnShortKeyAppend: TcxButton
    Left = 663
    Top = 56
    Width = 75
    Height = 50
    ...
    TabOrder = 1
    OnClick = btnShortKeyAppendClick
  end
  object btnShortKeyUpdate: TcxButton
    Left = 663
    Top = 112
    Width = 75
    Height = 50
    ...
    SpeedButtonOptions.Transparent = True
    TabOrder = 2
    OnClick = btnShortKeyUpdateClick
  end
  object cxDBMemo1: TcxDBMemo
    ...
    DataBinding.DataSource = dsShortKey
  ...
  object btnShortKeyDelete: TcxButton
    Left = 663
    Top = 168
    Width = 75
    Height = 50
    ...
    SpeedButtonOptions.Transparent = True
    TabOrder = 4
    OnClick = btnShortKeyDeleteClick
  end
  ...
  object pnlExp: TPanel
    ...
    Height = 13
    BevelOuter = bvNone
    Caption = #49440#53469' = Double Click '#54841#51008' Enter Key'
    Color = clMoneyGreen
    ParentBackground = False
    TabOrder = 6
  end
  object adoShortKey: TADOQuery
    Connection = dbMain.adoSocialWorkDB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'select * from ShortKeys')
    Left = 70
    Top = 114
  end
  object dsShortKey: TDataSource
    DataSet = adoShortKey
    OnDataChange = dsShortKeyDataChange
    Left = 70
    Top = 184
  end
end
