...
uses
  ...
  uVersionList in 'uVersionList.pas',
  uMonthReport in 'uMonthReport.pas' {frmMonthReport},
  uRecordMove in 'uRecordMove.pas' {frmRecordMove};
...
begin
  ...
  Application.CreateForm(TfrmKeywordMgr, frmKeywordMgr);
  Application.CreateForm(TfrmMonthReport, frmMonthReport);
  Application.CreateForm(TfrmRecordMove, frmRecordMove);
  Application.Run;
end.
