...
uses
  ...
  dxSkinsCore, dxSkinCaramel, dxPSPrVwStd, dxPSPrVwAdv,
  dxPSPrVwRibbon, dxPScxEditorProducers, dxPScxExtEditorProducers,
  dxPScxPageControlProducer, dxSkinsdxBarPainter, dxPSCore,
  ...
  dxSkinWhiteprint, dxSkinscxPCPainter, dxPScxGridLnk, dxPScxGridLayoutViewLnk,
  dxSkinsdxRibbonPainter, cxClasses;
